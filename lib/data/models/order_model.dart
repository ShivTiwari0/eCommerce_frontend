...
class OrderModel extends Equatable {
  ...
  OrderModel({this.sId,this.user, this.items,this.totalAmount, this.razorPayOrderId, this.status, this.updatedOn, this.createdOn, });
  ...
  Map<String, dynamic> toJson() {
    ...
    data['items']=items!.map((item) => item.toJson(productMode: true)).toList();
